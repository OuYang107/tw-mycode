          ...
          <el-col :span="4">
            <div class="grid-content">
              ...
              <el-autocomplete style="width: 130px"
                               ...
                               size="mini"
                               :trigger-on-focus="false"
                               @select="handleSubmitone">
              </el-autocomplete>
            </div>
          </el-col>
          <el-col :span="7">
            <div class="block grid-content">
              <span style="font-size: 12px width: 130px">导入日期：</span>
...
export default {
  ...
  methods: {
    ...
    query () {
      ...
      apiSend.findBlackSpotsInfo({ data: this.searchData }).then(res => {
        console.log(res)
    ...
    getDownload () {
      ...
      // let obj = { type: 10 }
      // let obj = "10"
      // apiSend.download5GSatisModel({ data: 10 }).then(res => {
