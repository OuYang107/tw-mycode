  ...
  <div class="page-container common-css">
    <div class="page-main">
      ...
      <el-table :data="tableData"
        ...
        <el-table-column prop="prodbidcode"
                         label="推荐类型编码">
        </el-table-column>
        <el-table-column prop="prodbidname"
                         label="推荐类型名称">
        </el-table-column>
        <el-table-column prop="prodsmallcode"
                         label="产品小类编码">
        </el-table-column>
        <el-table-column prop="prodsmallname"
                         label="产品小类名称">
        </el-table-column>
        <el-table-column prop="note"
                         label="备注">
        </el-table-column>
        <el-table-column prop="operationuser"
                         label="操作人">
        </el-table-column>
      ...
      <div class="dialog-top">
        ...
        <div class="dialog-right">
          ...
          <el-button type="success"
                     icon="el-icon-download"
                     size="small"
                     @click.native="downloadExcel">模板下载
          </el-button>
        </div>
      </div>
    ...
    <el-dialog :title="modalInfo.title"
      ...
      <el-form :model="ruleForm"
        ...
        <el-form-item class="menu-btn"
                      label="推荐类型编码"
                      prop="prodbidcode">
          <el-input v-model="ruleForm.prodbidcode"
                    placeholder="请输入推荐类型编码"></el-input>
        </el-form-item>
        <el-form-item class="menu-btn"
                      label="推荐类型名称"
                      prop="prodbidname">
          <el-input v-model="ruleForm.prodbidname"
                    placeholder="请输入推荐类型名称"></el-input>
        </el-form-item>
        <el-form-item class="menu-btn"
                      label="产品小类编码"
                      prop="prodsmallcode">
          <el-input v-model="ruleForm.prodsmallcode"
                    placeholder="请输入产品小类编码"></el-input>
        </el-form-item>
        <el-form-item class="menu-btn"
                      label="产品小类名称"
                      prop="prodsmallname">
          <el-input v-model="ruleForm.prodsmallname"
                    placeholder="请输入产品小类名称"></el-input>
        </el-form-item>
        <el-form-item class="menu-btn"
                      label="备注"
                      prop="note">
...
export default {
  ...
  methods: {
    exportTable () {
      ...
      params[key2] = ''
      download(this.baseUrl + '/IopChnnlDTableController/downChnlInfo',
        params, 'IOP渠道维表'
      )
    },
    downloadExcel () {
      ...
      //   window.location.href = this.baseUrl + '/IopChnnlDTableController/downloadChnlExcel'
      // } else {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (this.modalInfo.title == '新增框') {
            apiSend.canalInsertProdInfo({ data: this.ruleForm }).then((res) => {
            ...
            apiSend.canalUpdateChnlInfo({ data: this.ruleForm }).then((res) => {
              this.modalInfo.show = false;
    ...
    deleteTable () {
      ...
      this.$confirm('进行删除操作, 是否继续?', '提示', {
        ...
        apiSend.canalRemoveChnlByCode({ data: params }).then((res) => {
