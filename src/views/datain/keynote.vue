    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <el-table-column prop="q411Question"
                         label="Q4.1.1.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q412Question"
                         label="Q4.1.2.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q413Question"
                         label="Q4.1.3.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="q415Question"
                         label="Q4.1.5.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q415vQuestion"
                         label="Q4.1.5V.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q4198Question"
                         label="Q4.1.98.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q4199Question"
                         label="Q4.1.99.  您觉得企业宽带的上网质量有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q51Question"
                         label="Q5-1. 请问您是否就企业宽带向中国移动提出过报修或投诉？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="q521Question"
                         label="Q5.2.1. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q522Question"
                         label="Q5.2.2. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop=""
                         label="Q5.2.3. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q524Question"
                         label="Q5.2.4. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q525Question"
                         label="Q5.2.5. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q526Question"
                         label="Q5.2.6. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q527Question"
                         label="Q5.2.7. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q527vQuestion"
                         label="Q5.2.7V. 您认为企业宽带的故障或投诉处理服务有哪些地方可以改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <!-- 
...
export default {
  ...
  methods: {
    //查询按钮
    query () {
      apiSend.findGroupKDSatisInfo({ data: this.searchData }).then(res => {
        console.log(res)
    ...
    confirm () {  //确认按钮
      ...
      // return;
      let obj = []
      apiSend.groupKDSatisImport({ data: formData }).then(res => {
