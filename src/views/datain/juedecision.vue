  ...
  <div class="box">
    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <el-table-column prop="groupLvl"
                         label="单位级别"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="groupPolicyKeyman"
                         label="决策关键人姓名"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="groupContctKeyman"
                         label="联络关键人姓名"
                         width="105"
                         align="center">
        </el-table-column>

        <el-table-column prop="groupContctKeymanNo"
                         label="联络关键人手机号码"
                         width="105"
                         align="center">
        </el-table-column>
...
export default {
  ...
  methods: {
    //查询按钮
    query () {
      apiSend.findGroupPolicySatisInfo({ data: this.searchData }).then(res => {
        console.log(res)
    ...
    confirm () {  //确认按钮
      ...
      // return;
      let obj = []
      apiSend.groupPolicySatisImport({ data: formData }).then(res => {
