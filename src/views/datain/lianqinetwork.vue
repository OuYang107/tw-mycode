    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <el-table-column prop="d2Question"
                         label="D2.您是贵公司/单位中国移动业务的主要对接联系人吗？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="lq2Question"
                         label="LQ2.技术方案支撑"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq211Question"
                         label="LQ2.1.1.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq212Question"
                         label="LQ2.1.2.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq213Question"
                         label="LQ2.1.3.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq214Question"
                         label="LQ2.1.4.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq215Question"
                         label="LQ2.1.5.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq215vQuestion"
                         label="LQ2.1.5V.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq2198Question"
                         label="LQ2.1.98.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="lq2199Question"
                         label="LQ2.1.99.  您觉得技术解决方案有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="q211Question"
                         label="Q2.1.1. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q212Question"
                         label="Q2.1.2. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q213Question"
                         label="Q2.1.3. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q214Question"
                         label="Q2.1.4. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q215Question"
                         label="Q2.1.5. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q215vQuestion"
                         label="Q2.1.5V. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q2198Question"
                         label="Q2.1.98. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q2199Question"
                         label="Q2.1.99. 您觉得在合同承诺履约方面有哪些地方需要改进？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="q311Question"
                         label="Q3.1.1. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q312Question"
                         label="Q3.1.2. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q313Question"
                         label="Q3.1.3. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q314Question"
                         label="Q3.1.4. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q315Question"
                         label="Q3.1.5. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q316Question"
                         label="Q3.1.6. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q316vQuestion"
                         label="Q3.1.6V. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q3198Question"
                         label="Q3.1.98. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        <el-table-column prop="q3199Question"
                         label="Q3.1.99. 贵公司使用的集团产品出现过什么故障吗？"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="lq8Question"
                         label="LQ8.账单发票服务"
                         width="105"
                         align="center">
        </el-table-column>
...
export default {
  ...
  methods: {
    //查询按钮
    query () {
      apiSend.findGroupContctSatisInfo({ data: this.searchData }).then(res => {
        console.log(res)
    ...
    getDownload () {
      ...
      const base =
        process.env.NODE_ENV == "development"
          ...
          : baseUrl.production;
      let obj = { type: 2 }
      download(base + "/SatisfactionImport/download5GSatisModel", obj, "groupContctSatis")
      // window.open(
      //   base + "/dist/groupContctSatis.xlsx"
    ...
    confirm () {  //确认按钮
      ...
      // return;
      let obj = []
      apiSend.groupContctSatisImport({ data: formData }).then(res => {
