<template>
  <div class="box">
    <!-- <el-row>  11111111111111111111
      <el-col :span="24">
        <div class=" bg-purple-dark">总表 </div>
      </el-col>
    </el-row> -->
    <div class="content">
      <el-row>
    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <el-table-column label="移动"
                         align="center">
          <el-table-column prop="rsrvNum1"
                           label="表现值"
                           width="105"
                           align="center">
          </el-table-column>
          <el-table-column prop="rsrvNum2"
                           label="排名"
                           width="105"
                           align="center">
          </el-table-column>
        ...
        <el-table-column label="联通"
                         align="center">
          <el-table-column prop="rsrvNum3"
                           label="联通整体"
                           width="105"
                           align="center">
          </el-table-column>
          <el-table-column prop="rsrvNum4"
                           label="排名"
                           width="105"
                           align="center">
          </el-table-column>
        ...
        <el-table-column label="电信"
                         align="center">
          <el-table-column prop="rsrvNum5"
                           label="电信整体"
                           align="center"
                           width="105">
          </el-table-column>
          <el-table-column prop="rsrvNum6"
                           label="排名"
                           width="105"
                           align="center">
          </el-table-column>
          <!-- <el-table-column
          prop="telecomValidNum"
          label="电信有效样本"
          width="120"
          align="center"
        >
        ...
        <el-table-column label="领先情况"
                         align="center">
          <el-table-column prop="rsrvNum7"
                           label="领先值"
                           align="center"
                           width="105">
          </el-table-column>
          <el-table-column prop="rsrvNum8"
                           label="领先值排名"
                           width="105"
                           align="center">
          </el-table-column>
          <el-table-column prop="oppName"
                           label="强势竞争对手"
                           width="105"
                           align="center">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    confirm () {  //确认按钮
      ...
      // return;
      let obj = []
      apiSend.fileUpload({ data: formData }).then(res => {
