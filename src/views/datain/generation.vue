<template>
  <div class="box">
    <!-- <el-row>  11111111111111111111
      <el-col :span="24">
        <div class=" bg-purple-dark">5G </div>
      </el-col>
    </el-row> -->
    <div class="content">
      <el-row>
    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <!-- </el-table-column> -->
        <!-- <el-table-column label="联通"   align="center"> -->
        ...
        <el-table-column prop="q86Question"
                         label="Q8-1_6,%TEMP%官方网站（指网上营业厅）"
                         width="105"
                         align="center">
        </el-table-column>
        ...
        <el-table-column prop="q817Question12"
        ...
        <el-table-column prop="q215Question"
                         label="Q2-1_5,无5G信号覆盖（客户指明无5G信号，选此项）"
                         width="105"
                         align="center">
        </el-table-column>
...
export default {
  ...
  methods: {
    //查询按钮
    query () {
      apiSend.findFiveGSatisInfo({ data: this.searchData }).then(res => {
        console.log(res)
    ...
    confirm () {  //确认按钮
      ...
      // return;
      let obj = []
      apiSend.fiveGSatisImport({ data: formData }).then(res => {
