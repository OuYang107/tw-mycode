    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <el-table-column label="重点政企客户"
          ...
          <el-table-column prop="datarank"
                           label="排名"
                           width="120"
                           align="center">
          </el-table-column>
          <el-table-column prop="datanum"
                           label="移动有效样本"
                           width="120"
                           align="center">
          </el-table-column>
        </el-table-column>
        <el-table-column label="决策人"
                         align="center">
          ...
          <el-table-column prop="datarank2"
                           label="排名"
                           width="120"
                           align="center">
          </el-table-column>

          <el-table-column prop="datanum2"
                           label="联通有效样本"
                           width="120"
                           align="center">
          </el-table-column>
        ...
        <el-table-column label="联系人"
          ...
          <el-table-column prop="datarank3"
                           label="排名"
                           width="120"
                           align="center">
          </el-table-column>
          <el-table-column prop="datanum3"
                           label="电信有效样本"
                           width="120"
                           align="center">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    query () {
      //   this.handleChange()
      this.searchData.statisMonth = this.year + this.qishu
      apiSend.queryzhenqipagedata({ data: this.searchData }).then((res) => {
        console.log(res)
    ...
    // typeformatter (row) {
    //   // switch(row.statisMonth){
    //   //   case this.year + 'Q1' :
    //   //     return this.year  + "第一期";
    //   //  case this.year + 'Q2' :
    //   //     return this.year  + "第二期";
    //   //  case this.year + 'Q3' :
    //   //     return this.year  + "第三期";
    //   //  case this.year + 'Q4' :
    //   //     return this.year  + "第四期";
    //   // }
    //   return row.statisMonth.replace("Q1", "第一期").replace("Q2", "第二期").replace("Q3", "第三期").replace("Q4", "第四期")
    // }
  },
  computed: {
