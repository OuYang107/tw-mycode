  ...
  <div class="box">
    ...
    <div class="table">
      <el-table :data="tableData"
        ...
        <!-- <el-table-column label="决策人"  align="center">
        <el-table-column
          prop="uncomSatisScore"
          label="联通整体"
          width="120"
          align="center"
        >
